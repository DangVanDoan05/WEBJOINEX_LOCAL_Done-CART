...
function xshop_scripts()
{
	...
	wp_enqueue_style('xshop-mobile-menu', get_template_directory_uri() . '/assets/css/mobile-menu.css', array(), XSHOP_VERSION, 'all');
	...
	wp_enqueue_script('xshop-mobile-menu', get_template_directory_uri() . '/assets/js/mobile-menu.js', array(), XSHOP_VERSION, true);
